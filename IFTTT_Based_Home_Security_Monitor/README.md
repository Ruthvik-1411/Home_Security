...
The implementation is a bit longer as it includes the latency in data entry which results in no action sometimes. So those parts were not edited to show that latency.<br><br>
YouTube Demo Link: https://youtu.be/k3ATDimhBTE<br>
The .ino and .html codes can be seen above.
